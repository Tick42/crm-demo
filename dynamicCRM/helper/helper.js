...
function handleDOMLoaded(event) {
    ...
    document.getElementById("ucBtn").addEventListener("click", invokeUpdateContact);
    document.getElementById("rcBtn").addEventListener("click", invokeResolveContact);
...
function initializeGlueCore(token) {
    ...
    GlueCore({
            ...
            document.getElementById("logoffBtn").style.display = "inline";
            document.getElementById("loginBtn").style.display = "none";
            document.getElementById("ucBtn").style.display = "inline";
            document.getElementById("rcBtn").style.display = "inline";
...
function registerMethods() {
    glueCore.agm.register("Helper.UpdateContact", (args) => {
...
function invokeUpdateContact() {
    glueCore.agm.invoke("CRM.UpdateContact", {
        fullName: 'John Doe',
        contactId: '9666a1a3-71d9-438a-b559-3ce7e38a629b'
    });
}

function invokeResolveContact() {
    glueCore.agm.invoke("CRM.ResolveContact", {
